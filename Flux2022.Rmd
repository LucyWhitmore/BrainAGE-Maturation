...
Model Figures
```{r}
plot_model(baseline_puberty_y_mean_1, type="pred", terms = "youth_mean")

plot_model(baseline_puberty_p_mean_1, type="pred", terms = "parent_mean")

plot_model(baseline_cognition_1, type="pred", terms = "nihtbx_totalcomp_agecorrected")
