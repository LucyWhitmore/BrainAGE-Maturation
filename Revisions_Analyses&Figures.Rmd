...
vi_updated2 <- vi(extract_fit_parsnip(fit_workflow_combat))


#vi_model(abcd_model_obj_combat)
...
abcd_vi_followup <- left_join(vi(abcd_model_obj_combat_followup), abcd_vi_renamed)

abcd_vi_renamed_dk <- rio::import("~/Documents/FYP/abcd_vi_renamed_dk.csv") %>% 
  select(Variable, label, aseg_label)

abcd_vi_dk_followup <- left_join(vi(abcd_model_obj_combat_followup), abcd_vi_renamed_dk)
