...
baseline_pred_mod2_plot <- ggplot(abcd_brainage_baseline, aes(x=truth, y=corrected_pred)) + 
...
# Age Bias - truth vs corrected gap
baseline_gap_mod2_plot <- ggplot(abcd_brainage_baseline, aes(x=truth, y=corrected_gap)) + 
  geom_jitter(color="#E76F51")+
  geom_smooth(method=lm, color='#233D4D') +
  labs(x = "Scan/Chronological Age", y ="Corrected Gap") +
  theme_classic() + 
