...
# brainage ~ youth mean
baseline_puberty_y_mean_1 <- lm(corrected_gap ~ youth_mean + interview_age, data = sample_1_baseline)
baseline_puberty_y_mean_2 <- lm(corrected_gap ~ youth_mean + interview_age, data = sample_2_baseline)
...
summary(baseline_cognition__m2)
