...
summary(baseline_cognition_standard_1)
summary(baseline_cognition_standard_2)


summary(baseline_cognition_zscore_1)
summary(baseline_cognition_zscore_2)
...
Descriptive Stats
```{r}
describe(sample_1_baseline_months)

describe(sample_2_baseline_months)


nrow(sample_1_baseline_months %>% filter(sex == "F"))

nrow(sample_2_baseline_months %>% filter(sex == "F"))
...
Descriptive Stats
```{r}
describe(sample_1_followup_months)

describe(sample_2_followup_months)
```
