...
renamed_smri[,"FS_BrainSeg_Vol"] <- NA
renamed_smri[,"FS_BrainSeg_Vol_No_Vent"] <- NA
renamed_smri[,"FS_BrainSeg_Vol_No_Vent_Surf"] <- NA
renamed_smri[,"FS_SupraTentorial_Vol_No_Vent"] <- NA
renamed_smri[,"FS_SupraTentorial_No_Vent_Voxel_Count"] <- NA
renamed_smri[,"FS_Mask_Vol"] <- NA
renamed_smri[,"FS_BrainSegVol_eTIV_Ratio"] <- NA
renamed_smri[,"FS_MaskVol_eTIV_Ratio"] <- NA
renamed_smri[,"FS_L_Vessel_Vol"] <- NA
renamed_smri[,"FS_L_ChoroidPlexus_Vol"] <- NA
renamed_smri[,"FS_R_Vessel_Vol"] <- NA
renamed_smri[,"FS_R_ChoroidPlexus_Vol"] <- NA
renamed_smri[,"FS_OpticChiasm_Vol"] <- NA
renamed_smri[,"FS_Total_GM_Vol"] <- NA

#renamed_smri <- subset(renamed_smri, select = -c(269,279))


#Convert to numeric
renamed_smri[,6:279] <- sapply(renamed_smri[,6:279],as.numeric)
renamed_smri <- renamed_smri %>% 
